...
class App extends Container
{
    ...
    public function __construct(string $rootPath = '')
    {
        ...
        $vendorProviderFile = "{$rootPath}vendor/ruyicmf/cmf-{$appRootNamespace}/src/provider.php";
    ...
    protected function load(): void
    {
        ...
        $vendorEventFile = "{$rootPath}vendor/ruyicmf/cmf-{$appRootNamespace}/src/event.php";
