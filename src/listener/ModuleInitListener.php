...
class ModuleInitListener
{
    ...
    public function handle($param)
    {
        ...
        if (!is_dir($this->app->getAppPath() . $appName) && !is_dir(root_path() . "vendor/ruyicmf/cmf-app/src/{$appName}")) {
            return;
        }
        ...
        // 加载核心应用语言包
        $this->app->lang->load([
            root_path() . "vendor/ruyicmf/cmf-app/src/{$appName}/lang/{$langSet}.php",
        ]);
