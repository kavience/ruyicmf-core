...
class AdminInitListener
{
    ...
    public function handle($param)
    {
        ...
        foreach ($coreApps as $appName) {
            $langFiles[] = root_path() . "vendor/ruyicmf/cmf-app/src/{$appName}/lang/{$langSet}/admin_menu.php";
        }
        ...
        if (in_array($appName, $coreApps)) {
            $langFiles[] = root_path() . "vendor/ruyicmf/cmf-app/src/{$appName}/lang/{$langSet}/admin.php";
        }
